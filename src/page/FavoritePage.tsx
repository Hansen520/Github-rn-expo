...
class FavoritePage extends Component<any> {
...
const mapFavoriteStateToProps = (state: any) => ({
  theme: state.theme.theme,
});
//注意：connect只是个function，并不应定非要放在export后面
export default connect(mapFavoriteStateToProps)(FavoritePage);

class FavoriteTab extends Component<{tabLabel: string, favorite: any, onLoadFavoriteData: any, theme: any}> {
    private storeName: any;
    private favoriteDao: any;
  ...
  loadData(isShowLoading: boolean) {
  ...
  renderItem(data: any) {
    ...
    return <Item
      ...
      onFavorite={(item: any, isFavorite: boolean) => this.onFavorite(item, isFavorite)}
    />
  }
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  onLoadFavoriteData: (storeName: string, isShowLoading: boolean) =>
